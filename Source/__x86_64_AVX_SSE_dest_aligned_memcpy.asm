...
# References used to implement void __x86_64_AVX_SSE_dest_aligned_memcpy(void* dest_p, const void* source_p, size_t bytes_to_copy_p):
...
.global __x86_64_AVX_SSE_dest_aligned_memcpy # Declares the name as a global symbol, making it accessible to other parts of the program.


.section .text # Marks the beginning of the code section where executable instructions are defined.
__x86_64_AVX_SSE_dest_aligned_memcpy:
